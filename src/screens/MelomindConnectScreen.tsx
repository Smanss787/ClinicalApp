...
const MelomindConnectScreen = ({ navigation }: any) => {
  // Configuration state
  ...
  const channelNb = 2; // Melomind uses 2 channels
...
const QualityGradientProgressBar = ({ value }: { value: number }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      <Text style={styles.title}>Melomind Connect</Text>
...
export default MelomindConnectScreen; 